            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <strong>Detail</strong><br>
                  ...
                  <b>Jam Event:</b> {{ $data->waktu_event }}<br>
                  <b>Total Pembayaran: Rp </b> {{ number_format($data->total_pembayaran) }}<br>
                </div>
                <!-- /.col -->
                <div class="col invoice-col mb-4">
                    <strong>Detail Pembayaran</strong><br>
                    <b>Uang Muka: Rp </b> {{ number_format($data->uang_muka) }}<br>
                    <b>Sisa Pembayaran: Rp </b> {{ number_format($data->sisa_pembayaran) }}<br>
                    <b>Metode Pembayaran:</b> {{ $data->metode_pembayaran == 0 ? 'Belum Lunas' : 'Lunas' }}<br>
                    <b>Status Pembayaran:</b> {{  $data->verif == null ? 'Belum Terverifikasi' : 'Terverifikasi' }}<br>
                  </div>
              </div>
              <!-- /.row -->
