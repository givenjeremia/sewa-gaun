<div class="card mt-2">
    <div class="card-header">
      <h3 class="card-title">Penyewaaan Gaun</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr class=" bg-light text-nowrap">
              ...
              <td>
                {{ number_format($value->pembayaran[0]->uang_muka) }}
              </td>
              <td>
              ...
              <td>
                ...
                @endif
                <a href="#modalDetailPemesananGaun" data-toggle="modal" onclick="getDetailPenyewaan({{ $value->pembayaran[0]->id }})"  class="btn btn-success" ><i class="fa fa-wrench"></i></a>
              </td>
            </tr>
