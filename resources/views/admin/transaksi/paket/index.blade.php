...
{{-- Detail Gambar Gaun --}}
<div class="modal fade" id="modalDetailPemesananPaket" tabindex="-1" role="basic" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" id="modalContentDetailPemesananPaket">
...
@section('js_admin')
<script src="{{ asset('js/admin_js/pemesanan_paket.js') }}"></script>
@endsection
