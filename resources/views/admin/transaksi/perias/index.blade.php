...
{{-- Detail Gambar Gaun --}}
<div class="modal fade" id="modalDetailPemesananPerias" tabindex="-1" role="basic" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" id="modalContentDetailPemesananPerias">
...
@section('js_admin')
<script src="{{ asset('js/admin_js/pemesanan_perias.js') }}"></script>
@endsection
