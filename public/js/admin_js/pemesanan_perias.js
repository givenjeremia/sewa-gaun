...
function getData() {
    $.ajax({
        url: "/admin/transaksi-perias-ajax",
        type: "GET",
        dataType: "json",
        contentType: false,
        processData: false,
...
function getVerifModal(id){
    $.ajax({
        type: 'GET',
        url: '/admin/transaksi-perias-verify-form/'+id,
...
function submitVerif(id) {
    ...
    $.ajax({
        type: 'POST',
        url: '/admin/transaksi-perias-verify',
        data: {
            '_token': page,
            'pembayaran_id': id,
            'value': value_change
...
function getDetailPemesanan(id){
    $.ajax({
        type: 'GET',
        url: '/admin/pembayaran-perias/'+id,
   
        success: function(data) {
            $("#modalContentDetailPemesananPerias").html("");
            $("#modalContentDetailPemesananPerias").html(data.msg);
