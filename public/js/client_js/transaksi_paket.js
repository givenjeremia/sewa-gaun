...
var page = $("#transaksi_paket_page").val();
...
function detailTransaksiPemesananPaket(id) {
    url = "/detail-transaksi-paket/" + id;
    $.ajax({
        url: url,
        type: "GET",
        success: function (data) {
...
function getReviewForm(id){
    url = "/rating-review/create/paket/" + id;
    $.ajax({
        url: url,
        type: "GET",
        success: function (data) {
